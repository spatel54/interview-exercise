...
1. **docs/progress.md** — append RALPH block with current status, errors, next steps
2. **docs/plan.md** — update checkboxes; strike completed items
3. **docs/memory.md** — add any decision that must not be reversed
4. **Uncommitted work** — commit or document WIP in `docs/progress.md`
...
```markdown
Continuing interview-exercise. Read docs/progress.md and docs/plan.md first.
